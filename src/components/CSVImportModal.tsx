...
const CSVImportModal: React.FC<CSVImportModalProps> = ({ onClose, onImportComplete }) => {
  ...
  const downloadTemplate = () => {
    const template = `Nombre,Email,Teléfono,Empresa,Cargo,Estado,Origen,Interés,Probabilidad (%),Valor Estimado,Ciudad,País,Sitio Web,LinkedIn
"Juan Pérez","juan@ejemplo.com","(555) 123-4567","Empresa Ejemplo","Gerente","Primer contacto","Web","Alto","75","5000","San José","Costa Rica","https://ejemplo.com","https://linkedin.com/in/juan"
"María González","maria@test.com","(555) 987-6543","Test Corp","Directora","Segundo contacto","Referido","Medio","50","3000","Miami","Estados Unidos","","https://linkedin.com/in/maria"`;
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-800">Importar Contactos desde CSV</h2>
          <button
            onClick={onClose}
        ...
        <div className="p-6">
          ...
          <div className="mb-6">
            ...
            <ul className="text-sm text-gray-600 space-y-1">
              ...
              <li>• Los campos obligatorios son: Nombre y Email</li>
              <li>• Se detectarán y reportarán duplicados por email</li>
          ...
          {results && (
            <div className="mt-6 p-4 border rounded-lg">
              ...
              <div className="space-y-2">
                <p className="text-sm">
                  <span className="font-medium text-green-600">{results.success}</span> contactos importados exitosamente
                </p>
